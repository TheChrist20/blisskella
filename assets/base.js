...
console.log('Blisskella - Premium Fashion Clothing | Visit https://www.blisskella.com')
...
/*
  Navbar scroll behavior: switch to dark text/icons after passing
  the first 90vh of the page (i.e. 90% of the viewport height).
  Recalculates the threshold on resize so the behavior stays consistent
  across orientation/viewport changes.
*/
// navbar-scrolled behavior moved into the Navbar custom element in sections.js
